...
const packageName = "SignalDesk-Windows";
...
async function build() {
  ...
  await fs.writeFile(path.join(packageDir, "启动信号台.cmd"), `@echo off\r\nsetlocal\r\ncd /d "%~dp0"\r\nstart "Signal Desk Server" /min "%~dp0node.exe" "%~dp0server.js"\r\ntimeout /t 2 /nobreak >nul\r\nstart "" "http://127.0.0.1:4173"\r\nendlocal\r\n`, "utf8");
  await fs.writeFile(path.join(packageDir, "使用说明.txt"), `信号台 Signal Desk\r\n\r\n1. 解压整个文件夹。\r\n2. 双击“启动信号台.cmd”。\r\n3. 浏览器会打开 http://127.0.0.1:4173。\r\n\r\n刷新新闻需要联网。收藏和已读状态只保存在当前浏览器。\r\n关闭名为 Signal Desk Server 的最小化窗口即可停止服务。\r\n`, "utf8");
